    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-6 flex flex-col justify-end h-full text-white">
          ...
          <p className="text-xs md:text-sm text-justify font-light mt-1 md:mt-2">
            {description}
          </p>
          ...
          {externalLink ? (
            ...
            >
              <Button className="inline-flex items-center gap-2 text-white border bg-black border-black rounded-full px-5 py-2 hover:bg-gradient-to-r from-[#B16CEA] via-[#F5607A] to-[#FFA74B] hover:text-white hover:border-none hover:shadow-lg transition-all">
